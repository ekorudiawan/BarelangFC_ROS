...
cmd = "cd ~/BarelangFC_ROS/src/UPennalizers-master/Player; screen -S dcm lua run_dcm.lua; screen -S player lua walk_server.lua;"
...
def main():
	...
	rospy.init_node("barelang_motion_bridge")	
